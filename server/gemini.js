...

{
  ...
  "userInput": "<original user input> {only remove your name from userinput if exists} 
                ...
                to userInput me only wo search text jaye",
...
Type meanings:
- "general": if it's a factual or informational question aur agar koi aisa question puchta hai jiska answer tumhe pata hai usko bhi general ki category m rakho bas short answer dena.
